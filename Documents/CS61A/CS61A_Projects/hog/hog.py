...
def free_bacon(score):
    ...
    while cubed_score:
        ...
        new_sum_score += n * s
        s *= -1
    final_score = abs(new_sum_score) + 1
    return final_score
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            if abs(num_rolls0 - pre_score0) == 2 and feral_hogs == True:
                score0 += 3
            ...
            if abs(num_rolls1 - pre_score1) == 2 and feral_hogs == True:
                score1 += 3
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    i, max_score = 1, 0
    while i <= 10:
        averaged_roll_dice_num = make_averaged(roll_dice, num_samples)
        max_score_is_i = averaged_roll_dice_num(i, dice)
        if max_score_is_i > max_score:
            max_score = max_score_is_i
            max_score_roll_dice = i
        i += 1
    return max_score_roll_dice
    # END PROBLEM 9
